...
pub fn phone_locked_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M16,4.98v-1c0-0.82-0.67-1.5-1.5-1.5S13,3.15,13,3.98v1h-1v4h5v-4H16z M13.75,3.98c0-0.41,0.34-0.75,0.75-0.75 c0.41,0,0.75,0.34,0.75,0.75v1h-1.5V3.98z M17,12.37l0,4.67C9.27,17.04,2.96,10.73,2.96,3l4.67,0l0.79,3.55L5.98,8.98 c1.15,2.11,2.89,3.85,5,5l2.48-2.39L17,12.37L17,12.37z",
            }
        }
    }
}
        ...
        svg {
            ...
            g {
                g {
                    ...
                    path {
                        d: "M16,10c0-3.31-2.69-6-6-6s-6,2.69-6,6H3v4h2v-4c0-2.76,2.24-5,5-5s5,2.24,5,5v5H9v1h7v-2h1v-4H16z",
                    }
                }
            }
        }
...
pub fn video_chat_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M18,2H2v16l3-3h13V2z M14.5,11l-2-1.8V12h-7V5h7v2.8l2-1.8V11z",
                }
            }
        }
    }
