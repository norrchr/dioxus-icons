    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M10.28 2C5.67 1.85 2 5.53 2 10c0 4.42 3.58 8 8 8 2.97 0 5.55-1.62 6.93-4.02-6.01-.2-9.67-6.74-6.65-11.98z",
                    }
                }
            }
        }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M10.28 2c-1.79-.05-3.43.47-4.78 1.38l3.79 3.79c-.25-1.69.02-3.49.99-5.17zm-7.35.93L1.87 3.99 3.38 5.5C2.51 6.79 2 8.34 2 10c0 4.42 3.58 8 8 8 1.67 0 3.2-.52 4.48-1.39l1.53 1.53 1.06-1.06L2.93 2.93z",
                    }
                }
            }
        }
...
pub fn crop_5_4_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M17,4H3v12h14V4z M15.5,14.5h-11v-9h11V14.5z",
                }
            }
        }
    }
...
pub fn crop_7_5_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M17,5H3v10h14V5z M15.5,13.5h-11v-7h11V13.5z",
                }
            }
        }
    }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M14,5l-2-2H8L6,5H3v11h14V5H14z M10,14c-2.21,0-4-1.79-4-4H4.5l2-2l2,2H7c0,1.65,1.35,3,3,3c0.44,0,0.85-0.1,1.23-0.27 l0.73,0.73C11.38,13.8,10.72,14,10,14z M13.5,12l-2-2H13c0-1.65-1.35-3-3-3C9.56,7,9.15,7.1,8.77,7.27L8.04,6.54 C8.62,6.2,9.28,6,10,6c2.21,0,4,1.79,4,4h1.5L13.5,12z",
                    }
                }
            }
        }
        ...
        svg {
            ...
            g {
                g {
                    g {
                        path {
                            d: "M16,2H4v16h12V2z M9,4h4v6l-2-1l-2,1V4z M6,15l2.12-2.83L9.5,14l1.88-2.5L14,15H6z",
                        }
                    }
                }
            }
...
pub fn photo_album_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M20,2H4v20h16V2z M11,4h5v7l-2.5-1.5L11,11V4z M7,18l2.38-3.17L11,17l2.62-3.5L17,18H7z",
            }
        }
    }
}
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M4.64,19.37c3.03,3.03,7.67,3.44,11.15,1.25l-1.46-1.46c-2.66,1.43-6.04,1.03-8.28-1.21c-2.73-2.73-2.73-7.17,0-9.9 C7.42,6.69,9.21,6.03,11,6.03V9l4-4l-4-4v3.01c-2.3,0-4.61,0.87-6.36,2.63C1.12,10.15,1.12,15.85,4.64,19.37z",
                    }
                    g {
                        path {
                            d: "M17,7l-6,6l6,6l6-6L17,7z",
                        }
                    }
                }
            }
        ...
        svg {
            ...
            g {
                g {
                    ...
                    path {
                        d: "M10.75,7v1.63l5.5,5.5c0.47-0.94,0.75-2,0.75-3.13c0-1.66-0.58-3.19-1.55-4.39l1.08-1.08l-1.06-1.06l-1.08,1.08 C13.19,4.58,11.66,4,10,4C8.87,4,7.81,4.27,6.87,4.75L9.12,7H10.75z",
                    }
                    path {
                        d: "M1.87,3.99l2.66,2.66C3.57,7.84,3,9.35,3,11c0,3.87,3.13,7,7,7c1.65,0,3.16-0.57,4.35-1.52l1.66,1.66l1.06-1.06L2.93,2.93 L1.87,3.99z",
                    }
                }
            }
        }
