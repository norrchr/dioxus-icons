use dioxus::prelude::*;
use crate::IconProps;
pub fn bathroom_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn bed_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn bedroom_baby_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn bedroom_child_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn bedroom_parent_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn blender_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn camera_indoor_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn camera_outdoor_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn chair_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn chair_alt_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn coffee_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn coffee_maker_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn dining_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn doorbell_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn door_back_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn door_front_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn door_sliding_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn feed_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn flatware_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn garage_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn light_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn living_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn manage_search_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn podcasts_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn shower_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn table_bar_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
            ...
            g {
                g {
                    path {
                        d: "M18,6.5C18,5.12,14.42,4,10,4S2,5.12,2,6.5c0,1.3,3.18,2.37,7.25,2.49v3.51H7.61c-0.58,0-1.11,0.33-1.35,0.86L5,16h1.5 l1-2h5l1,2H15l-1.26-2.64c-0.25-0.52-0.78-0.86-1.35-0.86h-1.64V8.99C14.82,8.87,18,7.8,18,6.5z",
                    }
                }
            }
        }
...
pub fn table_bar_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
            ...
            g {
                g {
                    path {
                        d: "M22,7.5C22,5.57,17.52,4,12,4S2,5.57,2,7.5c0,1.81,3.95,3.31,9,3.48V15H9.35c-0.82,0-1.55,0.5-1.86,1.26L6,20h2l1.2-3h5.6 l1.2,3h2l-1.5-3.74C16.2,15.5,15.46,15,14.65,15H13v-4.02C18.05,10.81,22,9.31,22,7.5z",
                    }
                }
            }
        }
...
pub fn table_restaurant_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
            ...
            g {
                path {
                    d: "M17.93,7.63l-1.2-3C16.58,4.25,16.21,4,15.8,4H4.2C3.79,4,3.42,4.25,3.27,4.63l-1.2,3C1.81,8.29,2.29,9,3,9h1.27L3,16h1.5 l0.73-4h9.32l0.73,4h1.5L15.5,9H17C17.71,9,18.19,8.29,17.93,7.63z M5.5,10.5L5.77,9H14l0.27,1.5H5.5z",
                }
            }
        }
    }
...
pub fn table_restaurant_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
            ...
            g {
                g {
                    path {
                        d: "M21.96,9.73l-1.43-5C20.41,4.3,20.02,4,19.57,4H4.43C3.98,4,3.59,4.3,3.47,4.73l-1.43,5C1.86,10.36,2.34,11,3,11h2.2L4,20 h2l0.67-5h10.67L18,20h2l-1.2-9H21C21.66,11,22.14,10.36,21.96,9.73z M6.93,13l0.27-2h9.6l0.27,2H6.93z",
                    }
                }
            }
        }
...
pub fn window_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn window_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn yard_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
