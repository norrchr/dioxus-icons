use dioxus::prelude::*;
use crate::IconProps;
pub fn approval_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn attachment_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn attach_email_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn attach_email_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn cloud_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn cloud_circle_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn cloud_done_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn cloud_download_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn cloud_off_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn cloud_queue_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn cloud_sync_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn cloud_sync_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn cloud_upload_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn create_new_folder_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn difference_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
            ...
            g {
                path {
                    d: "M3.5,17.5H13V19H3.5C2.67,19,2,18.33,2,17.5V6h1.5V17.5z M17,5v9.5c0,0.83-0.67,1.5-1.5,1.5h-9C5.67,16,5,15.33,5,14.5v-12 C5,1.67,5.67,1,6.5,1H13L17,5z M13.25,11h-4.5v1.5h4.5V11z M13.25,6.5h-1.5V5h-1.5v1.5h-1.5V8h1.5v1.5h1.5V8h1.5V6.5z",
                }
            }
        }
    }
...
pub fn difference_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn download_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn downloading_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn download_done_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn download_for_offline_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn drive_file_move_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn drive_file_move_outline_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn drive_file_move_rtl_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn drive_file_move_rtl_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn drive_file_rename_outline_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn drive_folder_upload_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn file_download_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn file_download_done_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn file_download_off_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn file_download_off_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn file_open_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
            ...
            g {
                path {
                    d: "M14,17.74V13.5h4.24V15h-1.68l2.21,2.21l-1.06,1.06l-2.21-2.21v1.68H14z M12,2H5.5C4.67,2,4,2.67,4,3.5v13 C4,17.33,4.67,18,5.5,18h7v-6H16V6L12,2z M11,7V3l4,4H11z",
                }
            }
        }
    }
...
pub fn file_open_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn file_upload_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn file_upload_off_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
            ...
            g {
                g {
                    polygon {
                        points: "2.93,2.93 1.87,3.99 8,10.12 8,13 10.88,13 12.38,14.5 5,14.5 5,16 13.88,16 16.01,18.13 17.07,17.07",
                    }
                    polygon {
                        points: "12,8 15,8 10,3 7.56,5.44 12,9.88",
                    }
                }
            }
        }
...
pub fn file_upload_off_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn folder_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn folder_copy_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
            ...
            g {
                g {
                    ...
                    path {
                        d: "M16.5,4H11L9,2H5.5C4.67,2,4,2.67,4,3.5v9C4,13.33,4.67,14,5.5,14h11c0.83,0,1.5-0.67,1.5-1.5v-7C18,4.67,17.33,4,16.5,4z",
                    }
                }
            }
        }
...
pub fn folder_copy_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn folder_delete_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
            ...
            g {
                path {
                    d: "M16.5,6H10L8,4H3.5C2.67,4,2,4.67,2,5.5v9C2,15.33,2.67,16,3.5,16h13c0.83,0,1.5-0.67,1.5-1.5v-7C18,6.67,17.33,6,16.5,6z M15.5,10H15v2.5c0,0.55-0.45,1-1,1h-1.5c-0.55,0-1-0.45-1-1V10H11V9h1.5V8.5H14V9h1.5V10z M14,12.5h-1.5V10H14V12.5z",
                }
            }
        }
    }
...
pub fn folder_delete_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn folder_off_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
            ...
            g {
                g {
                    path {
                        d: "M2.22,2.22L1.16,3.28l1.22,1.22C2.15,4.77,2,5.12,2,5.5v9C2,15.33,2.67,16,3.5,16h10.38l2.84,2.84l1.06-1.06L2.22,2.22z",
                    }
                    path {
                        d: "M16.5,6H10L8,4H6.12l11.49,11.49C17.85,15.23,18,14.88,18,14.5v-7C18,6.67,17.33,6,16.5,6z",
                    }
                }
            }
        }
...
pub fn folder_off_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn folder_open_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn folder_shared_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn folder_zip_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
            ...
            g {
                path {
                    d: "M16.5,6H10L8,4H3.5C2.67,4,2,4.67,2,5.5v9C2,15.33,2.67,16,3.5,16h13c0.83,0,1.5-0.67,1.5-1.5v-7C18,6.67,17.33,6,16.5,6z M15,9h-1.5v1.5H15V12h-1.5v1.5H12V12h1.5v-1.5H12V9h1.5V7.5H15V9z",
                }
            }
        }
    }
...
pub fn folder_zip_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn format_overline_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn format_overline_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn grid_view_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn newspaper_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn newspaper_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn request_quote_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn rule_folder_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn snippet_folder_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn text_snippet_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn topic_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn upload_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn upload_file_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn workspaces_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn workspaces_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn workspaces_filled_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
...
pub fn workspaces_outline_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            id: props.id,
            class: props.class,
