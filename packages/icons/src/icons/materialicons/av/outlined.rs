...
pub fn audio_file_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M12,2H5.5C4.67,2,4,2.67,4,3.5v13C4,17.33,4.67,18,5.5,18h9c0.83,0,1.5-0.67,1.5-1.5V6L12,2z M5.5,16.5v-13H11V7h3.5v9.5 H5.5z M10,9h3.5v2H11v3c0,1.1-0.9,2-2,2s-2-0.9-2-2c0-1.1,0.9-2,2-2c0.37,0,0.7,0.11,1,0.28V9z",
                }
            }
        }
    }
