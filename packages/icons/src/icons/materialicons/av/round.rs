    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M8.5,8H6v1.5h2c0.55,0,1,0.45,1,1V12c0,0.55-0.45,1-1,1H5.5C5.22,13,5,12.78,5,12.5v0C5,12.22,5.22,12,5.5,12H8v-1.5H5.5 C5.22,10.5,5,10.28,5,10V7.5C5,7.22,5.22,7,5.5,7h3C8.78,7,9,7.22,9,7.5v0C9,7.78,8.78,8,8.5,8z",
                    }
                }
                g {
                    path {
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M11.25,5h-7.5C3.34,5,3,5.34,3,5.75v0C3,6.16,3.34,6.5,3.75,6.5h7.5C11.66,6.5,12,6.16,12,5.75v0C12,5.34,11.66,5,11.25,5 z",
                    }
                    path {
                        d: "M3.75,12.75h4.5C8.66,12.75,9,12.41,9,12v0c0-0.41-0.34-0.75-0.75-0.75h-4.5C3.34,11.25,3,11.59,3,12v0 C3,12.41,3.34,12.75,3.75,12.75z",
                    }
                    path {
                        d: "M11.25,8.12h-7.5C3.34,8.12,3,8.46,3,8.87v0c0,0.41,0.34,0.75,0.75,0.75h7.5c0.41,0,0.75-0.34,0.75-0.75v0 C12,8.46,11.66,8.12,11.25,8.12z",
                    }
                    path {
                        d: "M14.75,11.25v-2.5C14.75,8.34,14.41,8,14,8h0c-0.41,0-0.75,0.34-0.75,0.75v2.5h-2.5C10.34,11.25,10,11.59,10,12v0 c0,0.41,0.34,0.75,0.75,0.75h2.5v2.5c0,0.41,0.34,0.75,0.75,0.75h0c0.41,0,0.75-0.34,0.75-0.75v-2.5h2.5 c0.41,0,0.75-0.34,0.75-0.75v0c0-0.41-0.34-0.75-0.75-0.75H14.75z",
                    }
                }
            }
        }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M16.41,9.87l-3.01,3.01l-1.24-1.24c-0.29-0.29-0.77-0.29-1.06,0l0,0c-0.29,0.29-0.29,0.77,0,1.06l1.59,1.59 c0.39,0.39,1.02,0.39,1.41,0l3.36-3.36c0.29-0.29,0.29-0.77,0-1.06l0,0C17.18,9.58,16.7,9.58,16.41,9.87z",
                    }
                    path {
                        d: "M11.25,5h-7.5C3.34,5,3,5.34,3,5.75v0C3,6.16,3.34,6.5,3.75,6.5h7.5C11.66,6.5,12,6.16,12,5.75v0C12,5.34,11.66,5,11.25,5 z",
                    }
...
pub fn playlist_add_check_circle_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M10,2c-4.42,0-8,3.58-8,8s3.58,8,8,8s8-3.58,8-8S14.42,2,10,2z M6.75,6h4c0.41,0,0.75,0.34,0.75,0.75 c0,0.41-0.34,0.75-0.75,0.75h-4C6.34,7.5,6,7.16,6,6.75C6,6.34,6.34,6,6.75,6z M6.75,8.5h4c0.41,0,0.75,0.34,0.75,0.75 c0,0.41-0.34,0.75-0.75,0.75h-4C6.34,10,6,9.66,6,9.25C6,8.84,6.34,8.5,6.75,8.5z M7.75,12.5h-1C6.34,12.5,6,12.16,6,11.75 C6,11.34,6.34,11,6.75,11h1c0.41,0,0.75,0.34,0.75,0.75C8.5,12.16,8.16,12.5,7.75,12.5z M14.77,11.99l-2.3,2.3 c-0.39,0.39-1.02,0.39-1.41,0l-0.88-0.88c-0.29-0.29-0.29-0.77,0-1.06c0.29-0.29,0.77-0.29,1.06,0l0.53,0.53l1.94-1.94 c0.29-0.29,0.77-0.29,1.06,0C15.06,11.23,15.06,11.7,14.77,11.99z",
            }
        }
    }
}
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M13,11.42v4.66c0,0.4,0.44,0.64,0.77,0.42l3.58-2.33c0.3-0.2,0.3-0.64,0-0.84L13.77,11C13.44,10.79,13,11.02,13,11.42z",
                    }
                    path {
                        d: "M11.25,5h-7.5C3.34,5,3,5.34,3,5.75v0C3,6.16,3.34,6.5,3.75,6.5h7.5C11.66,6.5,12,6.16,12,5.75v0C12,5.34,11.66,5,11.25,5 z",
                    }
...
pub fn playlist_remove_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M3,5.75C3,5.34,3.34,5,3.75,5h7.5C11.66,5,12,5.34,12,5.75S11.66,6.5,11.25,6.5h-7.5C3.34,6.5,3,6.16,3,5.75z M3,12 c0-0.41,0.34-0.75,0.75-0.75h4.5C8.66,11.25,9,11.59,9,12s-0.34,0.75-0.75,0.75h-4.5C3.34,12.75,3,12.41,3,12z M12,8.87 c0,0.41-0.34,0.75-0.75,0.75h-7.5C3.34,9.62,3,9.28,3,8.87s0.34-0.75,0.75-0.75h7.5C11.66,8.12,12,8.46,12,8.87z M11.54,16.49 c0.3,0.3,0.77,0.29,1.07,0l1.41-1.41l1.41,1.41c0.29,0.3,0.77,0.3,1.07,0c0.3-0.3,0.29-0.77,0-1.07l-1.41-1.41l1.41-1.41 c0.3-0.29,0.3-0.77,0-1.07c-0.3-0.3-0.77-0.29-1.07,0l-1.41,1.41l-1.41-1.41c-0.29-0.3-0.77-0.3-1.07,0c-0.3,0.3-0.29,0.77,0,1.07 l1.41,1.41l-1.41,1.41C11.24,15.71,11.24,16.19,11.54,16.49z",
                }
            }
        }
    }
...
pub fn playlist_remove_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M13.71,21.3c0.39,0.39,1.02,0.39,1.41,0L17,19.41l1.89,1.89c0.39,0.39,1.02,0.39,1.41,0s0.39-1.02,0-1.41L18.41,18 l1.89-1.89c0.39-0.39,0.39-1.02,0-1.41s-1.02-0.39-1.41,0L17,16.59l-1.89-1.89c-0.39-0.39-1.02-0.39-1.41,0s-0.39,1.02,0,1.41 L15.59,18l-1.89,1.89C13.32,20.27,13.32,20.91,13.71,21.3z M14,11c0-0.55-0.45-1-1-1H4c-0.55,0-1,0.45-1,1s0.45,1,1,1h9 C13.55,12,14,11.55,14,11z M14,7c0-0.55-0.45-1-1-1H4C3.45,6,3,6.45,3,7s0.45,1,1,1h9C13.55,8,14,7.55,14,7z M3,15 c0,0.55,0.45,1,1,1h5c0.55,0,1-0.45,1-1s-0.45-1-1-1H4C3.45,14,3,14.45,3,15z",
                }
            }
        }
    }
        ...
        svg {
            ...
            g {
                g {
                    ...
                    path {
                        d: "M3.75,12.5h4.5C8.66,12.5,9,12.16,9,11.75v0C9,11.34,8.66,11,8.25,11h-4.5C3.34,11,3,11.34,3,11.75v0 C3,12.16,3.34,12.5,3.75,12.5z",
                    }
                    path {
                        d: "M11.25,8h-7.5C3.34,8,3,8.34,3,8.75v0C3,9.16,3.34,9.5,3.75,9.5h7.5C11.66,9.5,12,9.16,12,8.75v0C12,8.34,11.66,8,11.25,8 z",
                    }
                    path {
                        d: "M17.25,5H15c-0.55,0-1,0.45-1,1v5.21c-0.52-0.23-1.13-0.29-1.77-0.09c-0.79,0.25-1.43,0.9-1.64,1.7 c-0.44,1.67,0.8,3.17,2.39,3.19c1.41,0.01,2.52-1.25,2.52-2.66l0-6.84h1.75C17.66,6.5,18,6.16,18,5.75v0C18,5.34,17.66,5,17.25,5z",
                    }
                }
            }
        }
...
pub fn stop_circle_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M10,3c-3.87,0-7,3.13-7,7c0,3.87,3.13,7,7,7s7-3.13,7-7C17,6.13,13.87,3,10,3z M13,12.5c0,0.28-0.22,0.5-0.5,0.5h-5 C7.22,13,7,12.78,7,12.5v-5C7,7.22,7.22,7,7.5,7h5C12.78,7,13,7.22,13,7.5V12.5z",
            }
        }
    }
}
...
pub fn video_file_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M13.17,2H6.01c-1.1,0-2,0.89-2,2L4,20c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V8.83c0-0.53-0.21-1.04-0.59-1.41l-4.83-4.83 C14.21,2.21,13.7,2,13.17,2z M13,8V3.5L18.5,9H14C13.45,9,13,8.55,13,8z M14,14l1.27-0.67C15.6,13.15,16,13.39,16,13.77v2.46 c0,0.38-0.4,0.62-0.73,0.44L14,16v1c0,0.55-0.45,1-1,1H9c-0.55,0-1-0.45-1-1v-4c0-0.55,0.45-1,1-1h4c0.55,0,1,0.45,1,1V14z",
                }
            }
        }
    }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M3,14.5v-9C3,5.22,3.22,5,3.5,5h13C16.78,5,17,5.22,17,5.5V9h1V5c0-0.55-0.45-1-1-1H3C2.45,4,2,4.45,2,5v10 c0,0.55,0.45,1,1,1h8v-1H3.5C3.22,15,3,14.78,3,14.5z",
                    }
                    path {
...
pub fn web_asset_off_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M17.25,17.25L2.75,2.75c-0.29-0.29-0.77-0.29-1.06,0l0,0c-0.29,0.29-0.29,0.77,0,1.06L2.38,4.5C2.14,4.77,2,5.12,2,5.5v9 C2,15.33,2.67,16,3.5,16h10.38l2.31,2.31c0.29,0.29,0.77,0.29,1.06,0h0C17.54,18.02,17.54,17.54,17.25,17.25z M3.5,14.5V7h1.38 l7.5,7.5H3.5z M6.12,4H16.5C17.33,4,18,4.67,18,5.5v9c0,0.38-0.14,0.73-0.38,1l-1.12-1.12V7H9.12L6.12,4z",
                }
            }
        }
    }
