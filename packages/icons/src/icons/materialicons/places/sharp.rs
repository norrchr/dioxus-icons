...
pub fn crib_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M16,13.5V8h-6V4H7C5.34,4,4,5.34,4,7v6.5h3v2.27c-0.59-0.31-1.13-0.7-1.59-1.17l-1.06,1.06C5.79,17.1,7.79,18,10,18 c2.21,0,4.21-0.9,5.66-2.34l-1.06-1.06c-0.47,0.47-1,0.86-1.59,1.17l0-2.27H16z M11.5,16.33c-0.48,0.11-0.98,0.17-1.5,0.17 s-1.02-0.06-1.5-0.17V13.5h3V16.33z",
            }
        }
    }
}
...
pub fn iron_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M15,5.5v6h-1V6H6v2h1.5V7.5h5l0,1.5H5c-1.66,0-3,1.34-3,3v2.5h12V13h2.5V7H18V5.5H15z",
            }
        }
    }
}
