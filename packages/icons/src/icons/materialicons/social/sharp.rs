        ...
        svg {
            ...
            g {
                g {
                    ...
                    path {
                        d: "M21,3H3v18h18V3z M10,15H8.5v-4.5H7V9h3V15z M16,14c0,0.55-0.45,1-1,1h-2.5c-0.55,0-1-0.45-1-1v-4c0-0.55,0.45-1,1-1H15 c0.55,0,1,0.45,1,1V14z",
                    }
                }
            }
        }
...
pub fn back_hand_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M17.5,4h-2v6h-1V1.25h-2V10h-1V0l-2,0v10h-1V1.5h-2v11H6.25l-1.99-5L1.93,8.42l2.96,7.44C5.89,18.36,8.31,20,11,20l0,0 c3.59,0,6.5-2.91,6.5-6.5V4z",
            }
        }
    }
}
...
pub fn back_hand_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M2.21,10.47L5,9.36L7.25,15H8V2h2.5v10h1V0H14v12h1V1.5h2.5V12h1V4.5H21V16c0,4.42-3.58,8-8,8c-3.26,0-6.19-1.99-7.4-5.02 L2.21,10.47z",
            }
        }
    }
}
...
pub fn co2_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M12,8H9v4h3V8z M11,11h-1V9h1V11z M17,14h-3v-2.5h2V11h-2v-1h3v2.5h-2V13h2V14z M4,12V8h3v1.33H6V9H5v2h1v-0.34h1V12H4z",
            }
        }
    }
}
...
pub fn co2_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M15,9h-5v6h5V9z M13.5,13.5h-2v-3h2V13.5z M8,13v2H3V9h5v2H6.5v-0.5h-2v3h2V13H8z M18.5,15.5v1h3V18H17v-3.5h3v-1h-3V12h4.5 v3.5H18.5z",
            }
        }
    }
}
...
pub fn edit_notifications_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M12.53,12H9c0-1.93,0-3.5,0-3.5l3.71-3.71C12.19,4.47,11.62,4.23,11,4.1V2H9v2.1C6.72,4.56,5,6.58,5,9v5H4v1.5h12V14h-1 V9.53L12.53,12z M10,18c0.83,0,1.5-0.67,1.5-1.5h-3C8.5,17.33,9.17,18,10,18z M14.32,5.27l1.41,1.41l-3.82,3.82H10.5l0-1.41 L14.32,5.27z M14.81,4.77l0.63-0.63c0.2-0.2,0.51-0.2,0.71,0l0.71,0.71c0.2,0.2,0.2,0.51,0,0.71l-0.63,0.63L14.81,4.77z",
                }
            }
        }
    }
    ...
    rsx! {
        svg {
            ...
            g {
                ...
                path {
                    d: "M13,6V5H7v1H4v2c0,1.66,1.34,3,3,3h0.18c0.36,1.01,1.24,1.77,2.32,1.95V15H7v1h2.5h1H13v-1h-2.5v-2.05 c1.08-0.18,1.96-0.94,2.32-1.95H13c1.66,0,3-1.34,3-3V6H13z M7,10c-1.1,0-2-0.9-2-2V7h2V10z M15,8c0,1.1-0.9,2-2,2V7h2V8z",
                }
            }
        }
    }
    ...
    rsx! {
        svg {
            ...
            g {
                ...
                g {
                    path {
                        d: "M15,5H7.75v2.17L9,8v3H6V8l1.25-0.83V5H5v9h9V9h1c0.55,0,1-0.45,1-1V6C16,5.45,15.55,5,15,5z M15,8h-1V6h1V8z",
                    }
                    rect {
                        height: "1",
                        y: "15",
        ...
        svg {
            ...
            g {
                ...
                g {
                    ...
                    path {
                        d: "M15,9H9l-1,3v2v1v1h1v-1h6v1h1v-1v-1v-2L15,9z M9.72,10h4.56l0.67,2H9.05L9.72,10z M9.5,14C9.22,14,9,13.78,9,13.5 S9.22,13,9.5,13s0.5,0.22,0.5,0.5S9.78,14,9.5,14z M14.5,14c-0.28,0-0.5-0.22-0.5-0.5s0.22-0.5,0.5-0.5s0.5,0.22,0.5,0.5 S14.78,14,14.5,14z",
                    }
                }
            }
        }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M10,8h0.57V7.5H10c0-1.02-0.62-1.9-1.5-2.29v0.54C8.5,5.89,8.39,6,8.25,6S8,5.89,8,5.75v-0.7C7.84,5.02,7.67,5,7.5,5 S7.16,5.02,7,5.05v0.7C7,5.89,6.89,6,6.75,6S6.5,5.89,6.5,5.75V5.21C5.62,5.6,5,6.48,5,7.5H4.57V8H5H10z",
                    }
                    path {
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M10,2c-4.42,0-8,3.58-8,8s3.58,8,8,8s8-3.58,8-8S14.42,2,10,2z M10,16.5c-3.58,0-6.5-2.92-6.5-6.5 c0-0.17,0.01-0.33,0.03-0.5H5.4l2-3h5.2l2,3h1.88c0.01,0.17,0.03,0.33,0.03,0.5C16.5,13.58,13.58,16.5,10,16.5z",
                    }
                    circle {
                        r: "1",
                        cy: "10.5",
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M12,2C6.48,2,2,6.48,2,12s4.48,10,10,10c5.52,0,10-4.48,10-10S17.52,2,12,2z M12,20c-4.41,0-8-3.59-8-8h2.62l2-4h6.76l2,4 H20C20,16.41,16.41,20,12,20z",
                    }
                    circle {
                        cy: "13",
                        r: "1.25",
...
pub fn front_hand_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M10.5,20c-3.87,0-7-3.13-7-7V4h2v6h1V1.25h2V9h1V0h2v9h1V1.5h2l0,10.04c-1.69,0.24-3,1.7-3,3.46h1c0-1.38,1.12-2.5,2.5-2.5 h0.5v-6h2V13C17.5,16.87,14.37,20,10.5,20z",
            }
        }
    }
}
...
pub fn front_hand_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M18.5,8v7H18c-1.65,0-3,1.35-3,3h-1c0-2.04,1.53-3.72,3.5-3.97V2H15v9h-1V0h-2.5v11h-1V1.5H8V12H7V4.5H4.5v11.25 c0,4.56,3.69,8.25,8.25,8.25S21,20.31,21,15.75V8H18.5z",
            }
        }
    }
}
...
pub fn handshake_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M19.74,8.05l-6.8-6.8l-2.4,2.4l4.72,4.71l-2.26,2.26L8.88,6.49l-5.12,5.12l1.13,1.13l4.36-4.35l0.57,0.57l-4.36,4.35 l1.13,1.13l4.36-4.35l0.57,0.57L7.16,15l1.13,1.13l4.36-4.35l0.57,0.57L8.85,16.7l1.13,1.13L19.74,8.05z M7.03,1.26L0.26,8.03 L3.23,11l5.64-5.64l4.14,4.14l1.14-1.14L7.03,1.26z",
                }
            }
        }
    }
...
pub fn handshake_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M10.59,5.95l-7.05,7.04L0.7,10.3l8.55-8.55l7.95,7.95l-1.42,1.42L10.59,5.95z M23.24,10.24l-8.49-8.49l-2.06,2.06l5.9,5.88 l-2.83,2.83l-5.17-5.17l-6.27,6.27l1.42,1.41l5.32-5.32l0.71,0.71l-5.32,5.32l1.42,1.41l5.32-5.32l0.71,0.71l-5.32,5.32l1.41,1.41 l5.32-5.32l0.71,0.71L10.68,20l1.41,1.41L23.24,10.24z",
                }
            }
        }
    }
...
pub fn ice_skating_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M17.5,14c0,1.38-1.12,2.5-2.5,2.5h-1.5V15H16v-4.86l-5.18-1.57c-0.33-0.1-0.6-0.3-0.79-0.57H7V7h2.75V6H7V5h2.75V2.5H3V15 h2.5v1.5H2V18h13c2.21,0,4-1.79,4-4H17.5z M12,16.5H7V15h5V16.5z",
            }
        }
    }
}
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    polygon {
                        points: "6.44,7 8.5,18 11.5,18 13.56,7",
                    }
                    circle {
                        cy: "3.75",
                        r: "1.75",
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    polygon {
                        points: "7.96,7 10,22 14,22 16.04,7",
                    }
                    circle {
                        r: "2",
                        cx: "12",
...
pub fn military_tech_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M13.16,13.29l-2.27-0.19l-0.56-1.31L13,10V3H7v7l2.67,1.78l-0.56,1.31l-2.27,0.19l1.72,1.49L8.05,17L10,15.82L11.95,17 l-0.52-2.22L13.16,13.29z M9.5,4h1v6.46L10,10.8l-0.5-0.33V4z",
                }
            }
        }
    }
...
pub fn notification_add_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M15,11.03C13.52,10.3,12.5,8.77,12.5,7c0-0.73,0.17-1.41,0.48-2.02C12.4,4.56,11.73,4.25,11,4.1V2H9v2.1 C6.72,4.56,5,6.58,5,9v5H4v1.5h12V14h-1L15,11.03z M10,18c0.83,0,1.5-0.67,1.5-1.5h-3C8.5,17.33,9.17,18,10,18z M20,6.31h-2.25V4 h-1.5v2.31H14v1.38h2.25V10h1.5V7.69H20V6.31z",
                }
            }
        }
    }
...
pub fn paragliding_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M8.25,12.5c0-0.97,0.78-1.75,1.75-1.75s1.75,0.78,1.75,1.75s-0.78,1.75-1.75,1.75S8.25,13.47,8.25,12.5z M12.5,20v-3.38 c2.05-0.8,3.5-2.79,3.5-5.12h-1.5c0,2.21-1.79,4-4,4h-1c-2.21,0-4-1.79-4-4H4c0,2.33,1.45,4.32,3.5,5.12V20H12.5z M10,0 C5.03,0,1,1.56,1,3.48v3.17c0,0.61,0.68,0.95,1.19,0.61c0.1-0.07,0.2-0.13,0.31-0.19L4,10.5h1.5L7,5.7c0.94-0.13,1.95-0.2,3-0.2 s2.06,0.07,3,0.2l1.5,4.8H16l1.5-3.44c0.11,0.06,0.21,0.13,0.31,0.19C18.32,7.59,19,7.26,19,6.64V3.48C19,1.56,14.97,0,10,0z M4.72,9.64L3.4,6.61c0.7-0.29,1.52-0.54,2.44-0.72L4.72,9.64z M15.28,9.64l-1.13-3.75c0.92,0.19,1.75,0.43,2.44,0.72L15.28,9.64z",
                }
            }
        }
    }
...
pub fn piano_off_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M5.12,3H17v11.88l-1.5-1.5V4.5H14v7.38l-3-3V4.5H9v2.38L5.12,3z M16.01,18.13L14.88,17H3V5.12L1.87,3.99l1.06-1.06 l14.14,14.14L16.01,18.13z M7,12H6V8.12l-1.5-1.5v8.88H7V12z M12,15.5v-1.38l-3-3V12H8v3.5H12z",
                }
            }
        }
    }
...
pub fn precision_manufacturing_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M12.89,8.9L11,7.01V6.99l1.89-1.89l2.85,1.33l0.42-0.91L12.67,3.9L11,5.57V5h-1v1.5H7.93C7.71,5.64,6.93,5,6,5 C4.9,5,4,5.9,4,7c0,0.82,0.5,1.53,1.21,1.84L6.5,14H5v2h8v-2h-2.14L7.56,8.23C7.73,8.02,7.86,7.77,7.93,7.5H10V9h1V8.43l1.67,1.67 l3.49-1.63l-0.42-0.91L12.89,8.9z M6,8C5.45,8,5,7.55,5,7c0-0.55,0.45-1,1-1s1,0.45,1,1C7,7.55,6.55,8,6,8z",
                }
            }
        }
    }
...
pub fn real_estate_agent_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M11.5,1.5L6,5.5v2h1.5l8,2.85v2.15H17v-7L11.5,1.5z M11.12,8.25h-0.75V7.5h0.75V8.25z M11.12,6.75h-0.75V6h0.75V6.75z M12.62,8.25h-0.75V7.5h0.75V8.25z M12.62,6.75h-0.75V6h0.75V6.75z M1,18h3V9H1V18z M10.5,14l-1.53-0.51l0.36-1.01L10.5,13H14v-1.5 L7,9H5.5v7.36l6,1.64l6.5-2.5V14H10.5z",
            }
        }
    }
}
...
pub fn real_estate_agent_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M1,22h4V11H1V22z M14,1.5l-7,5V9h2l10,4v2h2V6.5L14,1.5z M13.5,10h-1V9h1V10z M13.5,8h-1V7h1V8z M15.5,10h-1V9h1V10z M15.5,8h-1V7h1V8z M22,19l-8,3l-7-1.98V11h1.97L17,14l0,2h-4l-1.76-0.68l-0.33,0.94L13,17h9V19z",
            }
        }
    }
}
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M20,16l-0.01-6l-5.71-1.43C13.4,8.35,12.7,7.76,12.32,7H9V6h3.02L12,5H9V4h3V1H4v15H20z M5,23c-1.66,0-3-1.34-3-3 s1.34-3,3-3s3,1.34,3,3S6.66,23,5,23z M19,23c-1.66,0-3-1.34-3-3s1.34-3,3-3s3,1.34,3,3S20.66,23,19,23z M12,23 c-1.66,0-3-1.34-3-3s1.34-3,3-3s3,1.34,3,3S13.66,23,12,23z",
                    }
                }
            }
        }
...
pub fn scoreboard_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M14,11h-1V9h1V11z M18,4h-4V2.5h-1.5V4h-5V2.5H6V4H2v12h16V4z M8,10.5H6V11h2v1H5V9.5h2V9H5V8h3V10.5z M10.5,14.5h-1v-1h1 V14.5z M10.5,11.83h-1v-1h1V11.83z M10.5,9.17h-1v-1h1V9.17z M10.5,6.5h-1v-1h1V6.5z M15,8v4h-3V8H15z",
                }
            }
        }
    }
...
pub fn scoreboard_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M17.5,13.5H16v-3h1.5V13.5z M22,4h-5V2h-2v2H9V2H7v2H2v16h20V4z M9.5,12.5h-3v1h3V15H5v-3.5h3v-1H5V9h4.5V12.5z M12.75,18 h-1.5v-1.5h1.5V18z M12.75,14.5h-1.5V13h1.5V14.5z M12.75,11h-1.5V9.5h1.5V11z M12.75,7.5h-1.5V6h1.5V7.5z M19,9v6h-4.5V9H19z",
                }
            }
        }
    }
...
pub fn single_bed_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M15,8V5H5v3H4v5h1l0.75,2h0.5L7,13h6l0.75,2h0.5L15,13h1V8H15z M6,8V6h3.5v2H6z M10.5,8V6H14v2H10.5z",
                }
            }
        }
    }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M15,6H5l-1,9h2l2-2h4l2,2h2L15,6z M9.25,9.75H8V11H7.5V9.75H6.25v-0.5H7.5V8H8v1.25h1.25V9.75z M11.5,9 C11.22,9,11,8.78,11,8.5C11,8.22,11.22,8,11.5,8S12,8.22,12,8.5C12,8.78,11.78,9,11.5,9z M12.5,11c-0.28,0-0.5-0.22-0.5-0.5 c0-0.28,0.22-0.5,0.5-0.5s0.5,0.22,0.5,0.5C13,10.78,12.78,11,12.5,11z",
                    }
                }
            }
        }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M10.53,11.53c0.39-0.39,0.55-0.92,0.44-1.45C10.86,9.54,10.51,9.11,10,8.91L5.8,7.18C4.34,8.64,3.64,10.56,3.31,12h6.08 C9.82,12,10.22,11.83,10.53,11.53z",
                    }
                    path {
                        d: "M16,7.15c-0.64-1.04-2.17-1.99-3.39-2.1C9.96,4.8,8.04,5.43,6.65,6.45l3.73,1.54c1.72,0.71,2.17,2.94,0.85,4.25 C10.75,12.73,10.08,13,9.39,13H3.11C3.01,13.65,3,14.07,3,14.07V16h8.5C15.61,16,18.67,11.49,16,7.15z",
                    }
                }
            }
        }
...
pub fn vaccines_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M15.75,9V8.5h0.75V7h-5.52L11,8.5h0.75V9c0,0-1.25,1-1.25,2.5V18H17v-6.75C17,10,15.75,9,15.75,9z M15.5,16.5H12V15h3.5 V16.5z M15.5,12H12v-0.5c0-1.13,1.25-1.25,1.25-2.5V8.5h1V9c0,1.25,1.25,1.37,1.25,2.5V12z M6,11l2,0v1.5H4.5v-6H8V8H6v1l2,0v1H6V11 z M2.25,6.5H3L3,14h2.5v3L7,18.5V14h2.5l0-7.5h0.75V5H7V3.5h1.25V2h-4v1.5H5.5V5H2.25V6.5z",
            }
        }
    }
}
...
pub fn wallet_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M18,4H2v12h16V4z M13.01,11.57L3.5,9.24V8.5h13v0.15L13.01,11.57z M16.5,7h-13V5.5h13V7z",
                }
            }
        }
    }
...
pub fn wallet_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M22,4H2v16h20V4z M15.75,14.09L4,11.22V10h16v0.53L15.75,14.09z M4,6h16v2H4V6z",
                }
            }
        }
    }
...
pub fn water_drop_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M10,2c0,0-6.5,5.16-6.5,9.5c0,3.59,2.91,6.5,6.5,6.5s6.5-2.91,6.5-6.5C16.5,7.16,10,2,10,2z M11,15.37 c-0.32,0.08-0.65,0.13-1,0.13c-2.21,0-4-1.79-4-4h1c0,1.65,1.35,3,3,3c0.35,0,0.69-0.06,1-0.17L11,15.37z",
            }
        }
    }
}
...
pub fn water_drop_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M12,2c-5.33,4.55-8,8.48-8,11.8c0,4.98,3.8,8.2,8,8.2s8-3.22,8-8.2C20,10.48,17.33,6.55,12,2z M13,18.91 C12.68,18.97,12.35,19,12,19c-2.69,0-4.88-1.94-5-5h1.5c0.08,2.07,1.5,3.5,3.5,3.5c0.35,0,0.69-0.04,1-0.13V18.91z",
            }
        }
    }
}
...
pub fn waving_hand_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M1,6c0-2.76,2.24-5,5-5v1C3.79,2,2,3.79,2,6H1z M19,14c0,2.76-2.24,5-5,5v-1c2.21,0,4-1.79,4-4H19z M3.05,16.95 c2.73,2.73,7.17,2.73,9.9,0l6.36-6.36L17.9,9.17l-4.24,4.24l-0.71-0.71l6.19-6.19l-1.41-1.41l-5.48,5.48l-0.71-0.71l6.36-6.36 L16.49,2.1l-6.36,6.36L9.41,7.76l5.3-5.3L13.3,1.04l-7.1,7.1c1.03,1.37,0.92,3.33-0.33,4.57L5.17,12c0.98-0.98,0.98-2.56,0-3.54 L4.82,8.11l4.24-4.24L7.65,2.45l-4.6,4.6C0.32,9.78,0.32,14.22,3.05,16.95z",
            }
        }
    }
}
...
pub fn waving_hand_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M23,17c0,3.31-2.69,6-6,6v-1.5c2.48,0,4.5-2.02,4.5-4.5H23z M1,7c0-3.31,2.69-6,6-6v1.5C4.52,2.5,2.5,4.52,2.5,7H1z M8.9,3.43L3.42,8.91c-3.22,3.22-3.22,8.44,0,11.67s8.44,3.22,11.67,0l7.95-7.95l-1.77-1.77l-5.3,5.3l-0.71-0.71l7.42-7.42 l-1.77-1.77l-6.72,6.72l-0.71-0.71l7.78-7.78L19.5,2.73l-7.78,7.78L11.02,9.8l6.36-6.36l-1.77-1.77l-8.51,8.51 c1.22,1.57,1.11,3.84-0.33,5.28l-0.71-0.71c1.17-1.17,1.17-3.08,0-4.24l-0.35-0.35l4.95-4.95L8.9,3.43z",
            }
        }
    }
}
        ...
        svg {
            ...
            g {
                g {
                    ...
                    polygon {
                        points: "11,7 9,7 6,14 8.5,14 8.5,18 11.5,18 11.5,14 14,14",
                    }
                }
            }
        }
