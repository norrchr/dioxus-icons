    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    polygon {
                        points: "4,8.5 2,8.5 2,11.5 4,11.5 4,16 8,16 8,14.5 5.5,14.5 5.5,10.25 3.5,10.25 3.5,9.75 5.5,9.75 5.5,5.5 8,5.5 8,4 4,4",
                    }
                    polygon {
                        points: "16,8.5 16,4 12,4 12,5.5 14.5,5.5 14.5,9.75 16.5,9.75 16.5,10.25 14.5,10.25 14.5,14.5 12,14.5 12,16 16,16 16,11.5 18,11.5 18,8.5",
                    }
                }
            }
        }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    polygon {
                        points: "4,10 2,10 2,14 4,14 4,20 10,20 10,18 6,18 6,12.5 4,12.5 4,11.5 6,11.5 6,6 10,6 10,4 4,4",
                    }
                    polygon {
                        points: "20,10 20,4 14,4 14,6 18,6 18,11.5 20,11.5 20,12.5 18,12.5 18,18 14,18 14,20 20,20 20,14 22,14 22,10",
                    }
                }
            }
        }
...
pub fn draw_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M18.85,10.39l2.48-2.48l-4.24-4.24l-2.48,2.48L18.85,10.39z M13.19,7.56L4,16.76V21h4.24l9.19-9.19L13.19,7.56z M19,17.5 c0,2.19-2.54,3.5-5,3.5c-0.48,0-1-0.07-1-0.07c0-0.34,0-2.03,0-2.03S13.46,19,14,19c1.54,0,3-0.73,3-1.5c0-0.47-0.48-0.87-1.23-1.2 l1.48-1.48C18.32,15.45,19,16.29,19,17.5z M4.58,13.35C3.61,12.79,3,12.06,3,11c0-1.8,1.89-2.63,3.56-3.36C7.59,7.18,9,6.56,9,6 c0-0.41-0.78-1-2-1C5.76,5,5,5.61,5,6H3c0-1.65,1.7-3,4-3c2.24,0,4,1.32,4,3c0,1.87-1.93,2.72-3.64,3.47C6.42,9.88,5,10.5,5,11 c0,0.31,0.43,0.6,1.07,0.86L4.58,13.35z",
            }
        }
    }
}
...
pub fn edit_note_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M3,5h9v1.5H3V5z M3,11.25h6v1.5H3V11.25z M3,8.12h9v1.5H3V8.12z M16.78,11.99l1.18-1.18l-1.77-1.77l-1.18,1.18L16.78,11.99z M16.19,12.58L11.77,17H10v-1.77l4.42-4.42L16.19,12.58z",
            }
        }
    }
}
...
pub fn edit_note_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M3,10h11v2H3V10z M3,8h11V6H3V8z M3,16h7v-2H3V16z M18.01,12.87l1.41-1.41l2.12,2.12l-1.41,1.41L18.01,12.87z M17.3,13.58 l-5.3,5.3V21h2.12l5.3-5.3L17.3,13.58z",
            }
        }
    }
}
        ...
        svg {
            ...
            g {
                g {
                    ...
                    path {
                        d: "M20,8l-6-6H4.01l-0.01,9H20V8z M13,9V3.5L18.5,9H13z",
                    }
                    rect {
                        width: "6",
                        height: "2",
            ...
            g {
                g {
                    ...
                    rect {
                        ...
                        width: "2.45",
                        height: "4.24",
                        transform: "matrix(0.7071 -0.7071 0.7071 0.7071 0.9061 12.0913)",
                        y: "2.83",
                    }
                }
            }
...
pub fn pentagon_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                polygon {
                    points: "2,7.5 5.3,17 14.7,17 18,7.5 10,2",
                }
            }
        }
    }
    ...
    rsx! {
        svg {
            ...
            g {
                ...
                path {
                    d: "M16,15v1h2v1h-3v-3l2,0l0-1h-2v-1l3,0v3L16,15z M5.63,14h1.9l2.43-3.87h0.08L12.47,14h1.9l-3.32-5.2l3.1-4.8h-1.91 l-2.19,3.56H9.96L7.75,4h-1.9l3.09,4.8L5.63,14z",
                }
            }
        }
    }
    ...
    rsx! {
        svg {
            ...
            g {
                ...
                path {
                    d: "M16,6v1h2v1l-3,0V5l2,0l0-1h-2V3l3,0v3L16,6z M5.63,16h1.9l2.43-3.87h0.08L12.47,16h1.9l-3.32-5.2l3.1-4.8h-1.91 l-2.19,3.56H9.96L7.75,6h-1.9l3.09,4.8L5.63,16z",
                }
            }
        }
    }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M18,2H5v13h13V2z M13.54,12l-0.63-1.79h-2.83L9.46,12H8.24l2.63-7h1.25l2.63,7H13.54z",
                    }
                    polygon {
                        points: "3.5,5 2,5 2,18 15,18 15,16.5 3.5,16.5",
                    }
                    polygon {
        ...
        svg {
            ...
            g {
                g {
                    ...
                    path {
                        d: "M22,2H6v16h16V2z M16.63,14.5l-0.8-2.3h-3.63l-0.82,2.3H9.81l3.38-9h1.61l3.38,9H16.63z",
                    }
                    polygon {
