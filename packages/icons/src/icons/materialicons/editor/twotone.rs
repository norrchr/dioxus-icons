...
pub fn area_chart_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            polygon {
                opacity: ".3",
                points: "15.5,13.8 10,9.39 7,13.5 4.5,11.62 4.5,8.8 6.31,10.01 10.26,5.07 13.5,7.5 15.5,7.5",
            }
            path {
                d: "M14,6l-4-3L6,8L3,6v10h14V6H14z M15.5,13.8L10,9.39L7,13.5l-2.5-1.88V8.8l1.81,1.21l3.95-4.94L13.5,7.5h2V13.8z",
            }
        }
    }
}
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M7.25,3h-1.5v2H4v10h1.75v2h1.5v-2H9V5H7.25V3z M7.5,6.5v7h-2v-7H7.5z",
                    }
                    rect {
                        x: "5.5",
                        y: "6.5",
                    ...
                    path {
                        d: "M14.25,7V3h-1.5v4H11v6h1.75v4h1.5v-4H16V7H14.25z M14.5,11.5h-2v-3h2V11.5z",
                    }
                }
            }
        }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M4,6.25v1.5C4,8.16,3.66,8.5,3.25,8.5H2v3h1.25C3.66,11.5,4,11.84,4,12.25v1.5C4,14.99,5.01,16,6.25,16H8v-1.5H6.25 c-0.41,0-0.75-0.34-0.75-0.75v-1.5c0-1.16-0.88-2.11-2-2.24V9.99c1.12-0.12,2-1.08,2-2.24v-1.5c0-0.41,0.34-0.75,0.75-0.75H8V4 H6.25C5.01,4,4,5.01,4,6.25z",
                    }
                    path {
                        d: "M16.75,8.5C16.34,8.5,16,8.16,16,7.75v-1.5C16,5.01,14.99,4,13.75,4H12v1.5h1.75c0.41,0,0.75,0.34,0.75,0.75v1.5 c0,1.16,0.88,2.11,2,2.24v0.03c-1.12,0.12-2,1.08-2,2.24v1.5c0,0.41-0.34,0.75-0.75,0.75H12V16h1.75c1.24,0,2.25-1.01,2.25-2.25 v-1.5c0-0.41,0.34-0.75,0.75-0.75H18v-3H16.75z",
                    }
                }
            }
        }
...
pub fn draw_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            polygon {
                opacity: ".3",
                points: "12.17,9.89 6.56,15.5 5.5,15.5 5.5,14.44 11.11,8.83",
            }
            path {
        ...
        svg {
            ...
            g {
                g {
                    g {
                        path {
                            d: "M5.5,3.5H11V7h3.5v2H16V6l-4-4H5.5C4.67,2,4,2.67,4,3.5V9h1.5V3.5z",
                        }
                        path {
                            d: "M14.5,16.5h-9V14H4v2.5C4,17.33,4.67,18,5.5,18h9c0.83,0,1.5-0.67,1.5-1.5V14h-1.5V16.5z",
                        }
                        rect {
                            height: "1.5",
                            y: "11",
                    ...
                    polygon {
                        opacity: ".3",
                        points: "11,7 11,3.5 5.5,3.5 5.5,9 14.5,9 14.5,7",
                    }
                }
            }
        }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    polygon {
                        points: "4.5,14.62 4.5,15.5 5.38,15.5 12.5,8.38 11.62,7.5",
                        opacity: ".3",
                        enable_background: "new",
                    }
                    path {
                        d: "M3,14v3h3l8.62-8.62l-3-3L3,14z M5.38,15.5H4.5v-0.88l7.12-7.12l0.88,0.88L5.38,15.5z",
                    }
                    path {
        ...
        svg {
            ...
            g {
                g {
                    ...
                    path {
                        d: "M11,9h7V4h-7V9z M12.5,5.5h4v2h-4V5.5z",
                    }
                    path {
                        d: "M5.57,11.94l1.06-1.06l2.87,2.87l-2.88,2.88l-1.06-1.06l1.06-1.06V14.5H6.25C3.35,14.5,1,12.15,1,9.25 C1,6.35,3.35,4,6.25,4H9.5v1.5H6.25C4.18,5.5,2.5,7.18,2.5,9.25C2.5,11.32,4.18,13,6.25,13h0.37v-0.01L5.57,11.94z",
                    }
                }
            }
        }
        ...
        svg {
            ...
            g {
                g {
                    ...
                    path {
                        d: "M11,16h7v-5h-7V16z M12.5,12.5h4v2h-4V12.5z",
                    }
                    path {
                        d: "M5.57,8.06l1.06,1.06L9.5,6.25L6.62,3.37L5.56,4.43l1.06,1.06V5.5H6.25C3.35,5.5,1,7.85,1,10.75C1,13.65,3.35,16,6.25,16 H9.5v-1.5H6.25c-2.07,0-3.75-1.68-3.75-3.75C2.5,8.68,4.18,7,6.25,7h0.37v0.01L5.57,8.06z",
                    }
                }
            }
        }
...
pub fn numbers_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M16.62,8.5L17,7h-3.25l0.75-3H13l-0.75,3h-3L10,4H8.5L7.75,7H4.38L4,8.5h3.37L6.5,12H3.38L3,13.5h3.12L5.5,16H7l0.62-2.5h3 L10,16h1.5l0.62-2.5h3.5L16,12h-3.5l0.88-3.5H16.62z M11,12H8l0.88-3.5h3L11,12z",
                }
            }
        }
    }
    ...
    rsx! {
        svg {
            ...
            g {
                polyline {
                    opacity: ".3",
                    points: "10,3.82 16.21,8.09 13.63,15.5 6.37,15.5 3.79,8.09 10,3.82",
                }
                path {
...
pub fn polyline_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M10,3.5h1.5V5H10V3.5z M6,11.5H4.5V10H6V11.5z M15.5,16.5H14V15h1.5V16.5z",
                    opacity: ".3",
                }
                path {
                    d: "M12.5,13.5v0.99l-5-2.71V9.24L9.83,6.5H13V2H8.5v3.75L6.16,8.5H3V13h3.6l5.9,3.2V18H17v-4.5H12.5z M10,3.5h1.5V5H10V3.5z M6,11.5H4.5V10H6V11.5z M15.5,16.5H14V15h1.5V16.5z",
                }
            }
        }
    }
        ...
        svg {
            ...
            g {
                ...
                g {
                    ...
                    polygon {
                        points: "15,3 14,3 14,5 14,5 12,5 12,6 14,6 14,8 15,8 15,6 15,6 17,6 17,5 15,5",
                    }
                }
            }
        }
...
pub fn schema_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                opacity: ".3",
                d: "M5.5,3.5H8V5H5.5V3.5z M8,17H5.5v-1.5H8V17z M8,10.75H5.5v-1.5H8V10.75z M15.5,10.75H13v-1.5h2.5V10.75z",
            }
            path {
                d: "M11.5,7.75v1.5h-2v-1.5h-2V6.5h2V2H4v4.5h2v1.25H4v4.5h2V14H4v4.5h5.5V14h-2v-1.75h2v-1.5h2v1.5H17v-4.5H11.5z M5.5,3.5H8V5 H5.5V3.5z M8,17H5.5v-1.5H8V17z M8,10.75H5.5v-1.5H8V10.75z M15.5,10.75H13v-1.5h2.5V10.75z",
            }
        }
    }
}
        ...
        svg {
            ...
            g {
                g {
                    ...
                    path {
                        d: "M5,9c2.21,0,4-1.79,4-4c0-2.21-1.79-4-4-4C2.79,1,1,2.79,1,5C1,7.21,2.79,9,5,9z M5,2.5c1.38,0,2.5,1.12,2.5,2.5 S6.38,7.5,5,7.5S2.5,6.38,2.5,5S3.62,2.5,5,2.5z",
                    }
                    path {
                        d: "M17.5,12h-4c-0.83,0-1.5,0.67-1.5,1.5v4c0,0.83,0.67,1.5,1.5,1.5h4c0.83,0,1.5-0.67,1.5-1.5v-4C19,12.67,18.33,12,17.5,12 z M17.5,17.5h-4v-4h4V17.5z",
                    }
                    path {
...
pub fn table_rows_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M15.5,4.5V7h-11V4.5H15.5z M15.5,8.5v3h-11v-3H15.5z M4.5,15.5V13h11v2.5H4.5z",
                opacity: ".3",
            }
            path {
                d: "M15.5,3h-11C3.67,3,3,3.67,3,4.5v11C3,16.33,3.67,17,4.5,17h11c0.83,0,1.5-0.67,1.5-1.5v-11C17,3.67,16.33,3,15.5,3z M15.5,4.5V7h-11V4.5H15.5z M15.5,8.5v3h-11v-3H15.5z M4.5,15.5V13h11v2.5H4.5z",
            }
        }
    }
}
...
pub fn text_decrease_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M18,9.25v1.5h-6v-1.5H18z M4.49,12.44h4.04L9.42,15h1.73L7.39,5H5.61L1.85,15h1.73L4.49,12.44z M6.07,8.02l0.39-1.16h0.08 l0.39,1.16l1.06,2.98H5.01L6.07,8.02z",
            }
        }
    }
}
...
pub fn text_increase_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M15.75,9.25H18v1.5h-2.25V13h-1.5v-2.25H12v-1.5h2.25V7h1.5V9.25z M4.49,12.44h4.04L9.42,15h1.73L7.39,5H5.61L1.85,15h1.73 L4.49,12.44z M6.07,8.02l0.39-1.16h0.08l0.39,1.16l1.06,2.98H5.01L6.07,8.02z",
            }
        }
    }
}
...
pub fn text_increase_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M1.99,19h2.42l1.27-3.58h5.65L12.59,19h2.42L9.75,5h-2.5L1.99,19z M6.41,13.39L8.44,7.6h0.12l2.03,5.79H6.41z M20,11h3v2h-3 v3h-2v-3h-3v-2h3V8h2V11z",
            }
        }
    }
}
        ...
        svg {
            ...
            g {
                g {
                    path {
                        opacity: ".3",
                        d: "M6.5,13.5h10v-10h-10V13.5z M10.87,5h1.25l2.63,7h-1.21l-0.63-1.79h-2.83L9.46,12H8.24L10.87,5z",
                    }
                    polygon {
                        points: "11.53,6.3 11.47,6.3 10.45,9.19 12.55,9.19",
                        opacity: ".3",
                    }
                    path {
                        d: "M3.5,5H2v11.5C2,17.33,2.67,18,3.5,18H15v-1.5H3.5V5z",
                    }
                    path {
                        d: "M16.5,2h-10C5.67,2,5,2.67,5,3.5v10C5,14.33,5.67,15,6.5,15h10c0.83,0,1.5-0.67,1.5-1.5v-10C18,2.67,17.33,2,16.5,2z M16.5,13.5h-10v-10h10V13.5z",
                    }
                    path {
                        d: "M10.09,10.21h2.83L13.54,12h1.21l-2.63-7h-1.25l-2.63,7h1.21L10.09,10.21z M11.47,6.3h0.06l1.02,2.89h-2.09L11.47,6.3z",
                    }
                }
            }
        }
