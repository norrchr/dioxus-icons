...
pub fn adf_scanner_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M18,9.5h-3V4H5v5.5H2V16h16V9.5z M13.5,9.5h-7v-4h7V9.5z M14.75,13.5c-0.41,0-0.75-0.34-0.75-0.75 c0-0.41,0.34-0.75,0.75-0.75s0.75,0.34,0.75,0.75C15.5,13.16,15.16,13.5,14.75,13.5z",
                }
            }
        }
    }
...
pub fn adf_scanner_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M22,12h-4V4H6v8H2v8h20V12z M16,12H8V6h8V12z M18,17c-0.55,0-1-0.45-1-1c0-0.55,0.45-1,1-1s1,0.45,1,1 C19,16.55,18.55,17,18,17z",
                }
            }
        }
    }
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    polygon {
                        points: "15,5 15,13.59 16,14.59 16,4 5.41,4 6.41,5",
                    }
                    path {
                        d: "M3.64,3.64L2.93,4.34L4,5.41V16h10.59l1.07,1.07l0.71-0.71L3.64,3.64z M5,15V6.41L13.59,15H5z",
                    }
                }
            }
        }
...
pub fn browser_updated_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M18,10.5V15h-5l1,1v1H6v-1l1-1H2V3h8.25v1.5H3.5v9h13v-3H18z M16.5,9l-3.25,0V3h-1.5v6L8.5,9l4,4L16.5,9z",
                }
            }
        }
    }
...
pub fn browser_updated_icons_24px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M22,13v5h-5l1,1v2H6v-2l1-1H2V3l10,0v2L4,5v11h16v-3H22z M15,15l-5-5h4V3h2v7h4L15,15z",
            }
        }
    }
}
...
pub fn developer_board_off_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M16.12,14H18v-1.5h-2v-1.75h2v-1.5h-2V7.5h2V6h-2V3H5.12l1.5,1.5h7.88v7.88L16.12,14z M8.12,6H9v0.88L8.12,6z M13,8h-2.88 L10,7.88V6h3V8z M11.12,9H13v1.88L11.12,9z M2.22,2.22L1.16,3.28L2,4.12L2,17h12.88l1.84,1.84l1.06-1.06L2.22,2.22z M3.5,15.5V5.62 L5,7.12V10h2.88l1,1H5v3h4v-2.88l1,1V14h1.88l1.5,1.5H3.5z",
            }
        }
    }
}
    ...
    rsx! {
        svg {
            ...
            g {
                ...
                path {
                    d: "M15,6V3H5v3c0,0,0,0,0,0L15,6C15,6,15,6,15,6z M14,5H6V4h8V5z M14,7H6l-3,7h14L14,7z M8.25,13h-1.5v-1h1.5V13z M8.25,11 h-1.5v-1h1.5V11z M8.25,9h-1.5V8h1.5V9z M10.75,13h-1.5v-1h1.5V13z M10.75,11h-1.5v-1h1.5V11z M10.75,9h-1.5V8h1.5V9z M13.25,13 h-1.5v-1h1.5V13z M13.25,11h-1.5v-1h1.5V11z M13.25,9h-1.5V8h1.5V9z M17,15l0,2H3l0-2H17z",
                }
            }
        }
    }
...
pub fn videogame_asset_off_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M17.12,15H18V5H7.12L17.12,15z M14.5,7.75c0.69,0,1.25,0.56,1.25,1.25s-0.56,1.25-1.25,1.25S13.25,9.69,13.25,9 S13.81,7.75,14.5,7.75z M17.07,17.07L2.93,2.93L1.87,3.99L2.88,5H2v10h10.88l3.13,3.13L17.07,17.07z M7.55,10.75v1.75h-1.5v-1.75 H4.3v-1.5h1.75V8.17l2.58,2.58H7.55z",
            }
        }
    }
}
