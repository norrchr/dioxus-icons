    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M3.5,14.5h13V11h-13V14.5z M14.75,12c0.41,0,0.75,0.34,0.75,0.75c0,0.41-0.34,0.75-0.75,0.75 S14,13.16,14,12.75C14,12.34,14.34,12,14.75,12z",
                        opacity: ".3",
                    }
                    rect {
                        height: "4",
...
pub fn browser_updated_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            g {
                path {
                    d: "M18,10.5v3c0,0.83-0.67,1.5-1.5,1.5H13l1,1v1H6v-1l1-1H3.5C2.67,15,2,14.33,2,13.5v-9C2,3.67,2.67,3,3.5,3h6.75v1.5H3.5v9 h13v-3H18z M16.5,9l-3.25,0V3h-1.5v6L8.5,9l4,4L16.5,9z",
                }
            }
        }
    }
...
pub fn developer_board_off_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M13,10.88V9h-1.88l-1-1H13V6h-3v1.88l-1-1V6H8.12l-1.5-1.5h7.88v7.88L13,10.88z M3.5,15.5V5.62L5,7.12V10 h2.88l1,1H5v3h4v-2.88l1,1V14h1.88l1.5,1.5H3.5z",
                opacity: ".3",
            }
            path {
...
pub fn start_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M13.12,5.62L17.5,10l-4.38,4.38l-1.06-1.06l2.56-2.56H5.5v-1.5h9.13L12.07,6.7L13.12,5.62z M2.5,5v10H4V5H2.5z",
            }
        }
    }
}
        ...
        svg {
            ...
            g {
                g {
                    path {
                        opacity: ".3",
                        d: "M14.25,10h-8.5c-0.69,0-1.25,0.56-1.25,1.25c0,0.24,0.09,0.46,0.21,0.65C5.12,11.36,5.77,11,6.5,11 c0.98,0,1.8,0.63,2.11,1.5h2.78c0.31-0.87,1.14-1.5,2.11-1.5c0.73,0,1.38,0.36,1.79,0.9c0.12-0.19,0.21-0.41,0.21-0.65 C15.5,10.56,14.94,10,14.25,10z",
                    }
                    path {
...
pub fn videogame_asset_off_icons_20px(props: IconProps) -> Element {
    rsx! {
        svg {
            ...
            path {
                d: "M8.62,6.5l7,7h0.88v-7H8.62z M14.5,10.25c-0.69,0-1.25-0.56-1.25-1.25s0.56-1.25,1.25-1.25 S15.75,8.31,15.75,9S15.19,10.25,14.5,10.25z M11.38,13.5l-2.75-2.75H7.55v1.75h-1.5v-1.75H4.3v-1.5h1.75V8.17L4.38,6.5H3.5v7H11.38 z",
                opacity: ".3",
            }
            path {
    ...
    rsx! {
        svg {
            ...
            g {
                g {
                    path {
                        d: "M8.76,14.83l0.41,1.67h1.65l0.41-1.67C10.84,14.93,10.43,15,10,15S9.16,14.93,8.76,14.83z",
                        opacity: ".3",
                    }
                    path {
                        opacity: ".3",
                        d: "M11.22,5.17l-0.4-1.67H9.18l-0.4,1.67C9.17,5.07,9.58,5,10,5S10.83,5.07,11.22,5.17z",
                    }
                    path {
